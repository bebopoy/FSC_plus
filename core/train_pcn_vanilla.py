...
from core.test_pcn_vanilla import test_net
from utils.average_meter import AverageMeter
from torch.optim.lr_scheduler import *
from utils.schedular import GradualWarmupScheduler
from utils.loss_utils_vanilla import *
...
from models.vanilla_model import PreModel as Model
    ...
    for epoch_idx in range(init_epoch + 1, cfg.TRAIN.N_EPOCHS + 1):
        ...
        with tqdm(train_data_loader) as t:
            for batch_idx, (taxonomy_ids, model_ids, data) in enumerate(t):
                ...
                wandb.log({"cd_pc": cd_pc_item, "cd_p1": cd_p1_item})
