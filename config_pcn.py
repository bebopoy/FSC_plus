...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '/mnt/data/ShapeNetCompletion/%s/partial/%s/%s/%02d.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '/mnt/data/ShapeNetCompletion/%s/complete/%s/%s.pcd'
