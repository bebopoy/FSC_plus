...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = 'datasets\ShapeNetCompletion\%s\partial\%s\%s\%02d.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = 'datasets\ShapeNetCompletion\%s\complete\%s\%s.pcd'
